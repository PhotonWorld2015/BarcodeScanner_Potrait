...
public class BarcodeScanner extends CordovaPlugin {
	...
	public boolean execute(String action, JSONArray args,
		...
		if (action.equals(ENCODE)) {
			...
			if (obj != null) {
				...
				if (data == null) {
					callbackContext
							.error("User did not specify data to encode");
					return true;
				}
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		if (requestCode == REQUEST_CODE) {
			 ...
			 * else if (resultCode == Activity.RESULT_CANCELED) { JSONObject obj
			 * = new JSONObject(); try { obj.put(TEXT, ""); obj.put(FORMAT, "");
			 * obj.put(CANCELLED, true); } catch (JSONException e) {
			 * Log.d(LOG_TAG, "This should never happen"); } //this.success(new
			 * PluginResult(PluginResult.Status.OK, obj), this.callback);
			 * this.callbackContext.success(obj); } else { //this.error(new
			 * PluginResult(PluginResult.Status.ERROR), this.callback);
